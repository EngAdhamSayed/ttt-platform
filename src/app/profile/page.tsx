...
export default function ProfilePage() {
  ...
  const fetchProfileData = async () => {
    ...
    if (friendIds.length > 0) {
      ...
      setFriends([
        { id: "f1", full_name: "NasrEldeen Elwazery", mutual: "1 جديد" },
        { id: "f2", full_name: "Abdalla Ahmed", mutual: "13 صديق مشترك" },
        { id: "f3", full_name: "Wesam Hesham", mutual: "12 صديق مشترك" },
        { id: "f4", full_name: "Mostafa A Khadrawy", mutual: "5 أصدقاء مشتركين" },
      ]);
    }
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-slate-900 font-sans select-none pb-24 text-right" dir="rtl">
      ...
      {/* 🟢 1. منطقة الغلاف والصورة والهيدر المنسق */}
      <div className="bg-white shadow-sm border-b border-slate-100 pb-4">
        ...
        <div className="h-44 md:h-52 w-full bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 relative overflow-hidden">
          ...
          {/* زر كاميرا الغلاف (شغال ويحفظ في DB) */}
          <button
        ...
        {/* الصورة الشخصية على اليمين وبجانبها الاسم | الإحصائيات في أقصى الشمال */}
        <div className="max-w-lg mx-auto px-4 -mt-12 relative flex items-end justify-between">
          
          {/* الصورة الشخصية والاسم بجانبها مباشرة */}
          ...
          {/* الإحصائيات في أقصى الشمال (المحدد بالبنفسجي) */}
          <div className="text-left text-xs font-bold text-slate-500 pb-1" dir="ltr">
            <span>{friends.length} friends • {posts.length} posts</span>
          </div>
        </div>

        {/* الرتبة والرانك + البايو + أزرار الإجراءات */}
      ...
      {/* 🟢 3. الأقسام التفصيلية من فيسبوك بالكامل */}
        ...
        <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm space-y-3">
          ...
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
            <div className="flex-shrink-0 w-20 h-32 rounded-2xl bg-slate-50 border-2 border-dashed border-slate-300 flex flex-col items-center justify-center gap-1 cursor-pointer hover:bg-orange-50/50 transition">
              <div className="w-7 h-7 rounded-full bg-orange-500 text-white flex items-center justify-center font-black">
                <Plus className="w-4 h-4" />
              </div>
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-5 w-full max-w-sm space-y-3.5 shadow-2xl text-right">
            ...
            <textarea
              ...
              placeholder="اكتب فكرة سريعة أو حالة يراها أصدقاؤك..."
